...
part '../controller/month_year_dialog_controller.dart';
part 'month_picker_dialog.dart';
part 'year_picker_dialog.dart';
...
class _CustomMonthPickerState extends State<_CustomMonthPicker> {
  late _MonthYearDialogController controller;

  @override
  void initState() {
    super.initState();
    // initialize the controller with the required parameters
    controller = _MonthYearDialogController.of(
  ...
  void pop() {
    ...
    Get.delete<_MonthYearDialogController>();
  }
}
